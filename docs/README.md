...
| [api/profile-frontend.md](api/profile-frontend.md) | Frontend-facing contract for profile/account endpoints, onboarding story/tag flow, auth requirements, example payloads, and error cases. |
