...
const routes: RouteSpec[] = [
  ...
  {
    method: "get",
    path: "/v2/friends/requests/incoming",
    summary: "List incoming (pending) friend requests",
    tag: "Friends",
    schema: listFriendRequestsSchema,
    successStatus: 200,
    requiresAuth: true,
  },
  {
    method: "get",
    path: "/v2/friends/requests/outgoing",
  ...
  {
    method: "post",
    path: "/v2/friends/requests/{requestId}/accept",
    summary: "Accept a friend request",
    tag: "Friends",
    schema: friendRequestIdSchema,
    successStatus: 200,
    requiresAuth: true,
  },
  {
    method: "post",
    path: "/v2/friends/requests/{requestId}/reject",
  ...
  {
    method: "delete",
    path: "/v2/friends/requests/{requestId}",
  ...
  {
    method: "get",
    path: "/v2/friends/status/{userId}",
    summary: "Get relationship status with a user",
    tag: "Friends",
    schema: friendshipStatusSchema,
    successStatus: 200,
    requiresAuth: true,
  },
  {
  ...
  {
    method: "delete",
    path: "/v2/friends/{friendId}",
    summary: "Remove a friend (unfriend)",
    tag: "Friends",
    schema: friendIdSchema,
    successStatus: 200,
    requiresAuth: true,
  },
  {
